...
public class PluginServiceRegistrator : IPluginServiceRegistrator
{
    ...
    public void RegisterServices(IServiceCollection serviceCollection, IServerApplicationHost applicationHost)
    {
        ...
        // v3.0.20: TMDB wrapper used by trailers, genre rails, top-10.
        ...
        serviceCollection.AddTransient<ClientScriptInjectionMiddleware>();
        // Wire middleware into the ASP.NET Core pipeline via IStartupFilter.
        // The injection middleware MUST be registered so that bootstrap.js is
        // injected into /web/index.html — without it, the plugin has no
        // visible effect on the Jellyfin home screen.
        serviceCollection.AddSingleton<IStartupFilter, BadgeMiddlewareStartup>();
        serviceCollection.AddSingleton<IStartupFilter, ClientScriptInjectionStartup>();
