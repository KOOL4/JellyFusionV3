...
public class StartupInjectionService : IScheduledTask
{
    ...
    public IEnumerable<TaskTriggerInfo> GetDefaultTriggers()
    {
        ...
        {
            // v3.0.12: 10.11 REMOVED the static string constants on
            // TaskTriggerInfo and now requires the TaskTriggerInfoType
            // enum (which 10.10 didn't have). v3.0.9 used the constant,
            // v3.0.11 dropped 10.10 support so we can use the enum
            // freely now.
