...
(function () {
    ...
    function injectBaseStyles() {
        ...
        var css = [
            ...
            // v3.0.23: horizontal (16:9) format for "Recently Added"
            // style rows. Larger card width since horizontal needs more
            // breathing room. Image is sourced from Backdrop instead of
            // Primary so we get a landscape still.
            ".jf-rail.jf-format-horizontal .jf-card{width:280px;aspect-ratio:16/9;}",
            ".jf-rail.jf-format-horizontal .jf-card img{aspect-ratio:16/9;}",
            ".jf-rail.jf-format-horizontal .jf-card .jf-rank{font-size:42px;}",
        ...
        fetchJson("/jellyfusion/home/rails").then(function (rails) {
            ...
            rails.forEach(function (rail) {
                ...
                var cards = rail.items.map(function (it, idx) {
                    ...
                    // v3.0.23: pick image type matching the rail format.
                    // Backdrop is the wide 16:9 still; Primary is the 2:3
                    // poster. Falling back to Primary if Backdrop 404s
                    // would cost extra round-trips so we just trust the
                    // rendered onerror to hide the broken image.
                    var img = fmt === "horizontal"
