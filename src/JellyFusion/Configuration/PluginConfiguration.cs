...
public class HomeRail
{
    ...
    /// <summary>
    /// v3.0.23 — card layout for this rail.
    /// "Poster"     = vertical 2:3 cards (the default Jellyfin movie poster).
    /// "Horizontal" = 16:9 thumbnail cards (good for "Recently Added" rows).
    /// Bootstrap.js applies a CSS class jf-format-{value} to the rail
    /// container so the cards render with the right aspect ratio.
    /// </summary>
    public string Format { get; set; } = "Poster";

    /// <summary>
    /// v3.0.23 — for rails of kind "library:&lt;Name&gt;" this carries
    /// the human-readable library name to filter by. Null for built-in
    /// rails like top10Movies / continueWatching.
    /// </summary>
